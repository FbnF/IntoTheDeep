...
public class DriveConstants {
    ...
    //For 52 mm radius wheels
    public static double WHEEL_RADIUS = 52 / 25.4; // in inch

    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 20.34;// in in starting 11.5
     ...
     * inches.
     */
    public static double MAX_VEL = 48; // 38
    public static double MAX_ACCEL = 32;//25
    public static double MAX_ANG_VEL = Math.toRadians(321.5);
    public static double MAX_ANG_ACCEL = Math.toRadians(250);// 200
